...
1을 얻기 위해서는 FSB를 통해 got의 값을 아무거나 읽으면 된다. 하지만 PIE가 적용되어 있어 got의 위치가 매번 바뀐다. 이는 return address를 선제적으로 알아내  code base을 구함으로서 해결할 수 있다. code offset에 binary
2 또한 
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4OTM3NjA5NDMsLTE0MDk5NDI0MTYsLT
IxMjgwMzIyMzJdfQ==
-->