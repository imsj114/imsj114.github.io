...
이번 문제를 풀면서 base64에 대해 처음으로 알게 되었는데, 자세한 설명은 [여기]([https://effectivesquid.tistory.com/entry/Base64-%EC%9D%B8%EC%BD%94%EB%94%A9%EC%9D%B4%EB%9E%80](https://effectivesquid.tistory.com/entry/Base64-%EC%9D%B8%EC%BD%94%EB%94%A9%EC%9D%B4%EB%9E%80))서 찾아볼 수 있다. 간단히 말하자면 base64는 ASCII 코드 중에서 잘 사용되는 64개의 문자를 골라서 64진법으로 나타내는 일종의 인코딩이다.

##풀ㅇ
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MDYzMzYxODksLTQzMTIzOTA1N119
-->