...
canary의 값을 구할 때 integer overflow를 python으로 구현해야 했는데, 단순히 0x100000000으로

2번 항목에서 payload를 그대로 입력으로 넣지 않고 base64로 인코딩하는 점은 신선했다. 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ5NTI5Njc0OCwtNDMxMjM5MDU3XX0=
-->